...
namespace Talifun.Web
{
    public class Hasher : IHasher
    {
        ...
        public string CalculateMd5Etag(Stream stream)
        {
            if (stream.CanSeek)
            {
        ...
        /// <returns>A string containing an MD5 hash that can be used in an HTTP ETAG header.</returns>
        public string CalculateMd5Etag(Stream stream, int beginRange, int endRange)
        {
        ...
        /// <returns>A string containing an MD5 hash that can be used in an HTTP ETAG header.</returns>
        public string CalculateMd5Etag(FileInfo fileInfo)
        {
