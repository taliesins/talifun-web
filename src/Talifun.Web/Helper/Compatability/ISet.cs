...
/// <summary>
  ...
  /// 
  /// <listheader>
  /// <term>Operation</term><term>Description</term><term>Method</term>
  /// </listheader>
  /// 
  /// <item>
  /// <term>Union (OR)</term><term>Element included in result if it exists in either <c>A</c> OR <c>B</c>.</term><term><c>Union()</c></term>
  /// </item>
  /// 
  /// <item>
  /// <term>Intersection (AND)</term><term>Element included in result if it exists in both <c>A</c> AND <c>B</c>.</term><term><c>InterSect()</c></term>
  /// </item>
  /// 
  /// <item>
  /// <term>Exclusive Or (XOR)</term><term>Element included in result if it exists in one, but not both, of <c>A</c> and <c>B</c>.</term><term><c>ExclusiveOr()</c></term>
  /// </item>
  /// 
  /// <item>
  /// <term>Minus (n/a)</term><term>Take all the elements in <c>A</c>.  Now, if any of them exist in <c>B</c>, remove
  ///             		them.  Note that unlike the other operators, <c>A - B</c> is not the same as <c>B - A</c>.</term><term><c>Minus()</c></term>
  /// </item>
  /// 
  /// </list>
  /// 
